...
export default function PropertyCard(props){
    return(
        <>
            <div className="flex border-b-2  w-[93%] border-gray-800 pb-2 pt-5 justify-between font-semibold mx-10 hover:bg-zinc-700 hover:cursor-pointer transition-all  text-black">
