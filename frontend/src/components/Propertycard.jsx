...
export default function PropertyCard(props){
    ...
    return(
        ...
        <figure><img 
                        src={props.img} 
                        alt="Property" 
                        className="w-full h-[20rem] object-fit" 
                    /></figure>
        <div className="card-body">
            ...
            <button onClick={viewProperty} class="active:scale-95 rounded-2xl  px-6  hover:text-white border border-slate-300 hover:bg-black hover:border-black transition-all py-2 font-raleway font-medium text-black outline-none focus:ring hover:opacity-90">View Property</button>
            </div>
        </div>
        </div>
        </>
