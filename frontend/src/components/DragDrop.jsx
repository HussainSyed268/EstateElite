                ...
                <div className=" relative w-[70%] h-44 mt-4">
                    {currentIndex > 0 && (
                        <button
                            ...
                            className="absolute z-10 left-0 top-[45%] transform -translate-y-1/2 text-2xl text-black bg-white bg-opacity-75 p-1 rounded-full"
                        >
                            <FaChevronLeft />
                        </button>
                    )}
                    ...
                    {currentIndex + 3 < tempFiles.length && (
                        <button
                            ...
                            className="absolute right-0 top-[45%] transform -translate-y-1/2 text-2xl text-black bg-white bg-opacity-75 p-1 rounded-full"
                        >
                            <FaChevronRight />
                        </button>
                    )}
